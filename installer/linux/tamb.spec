...
install -m 0755 -d $RPM_BUILD_ROOT/opt/thingamablog-%{version}/languages
install -m 0755 -d $RPM_BUILD_ROOT/opt/thingamablog-%{version}/dictionaries
install -m 0755 -d $RPM_BUILD_ROOT/opt/thingamablog-%{version}/template_sets
...
install -m 0644 languages/* $RPM_BUILD_ROOT/opt/thingamablog-%{version}/languages/
install -m 0644 dictionaries/* $RPM_BUILD_ROOT/opt/thingamablog-%{version}/dictionaries/
install -m 0644 template_sets/* $RPM_BUILD_ROOT/opt/thingamablog-%{version}/template_sets/
#cp -ra template_sets/* $RPM_BUILD_ROOT/opt/thingamablog-%{version}/template_sets/
